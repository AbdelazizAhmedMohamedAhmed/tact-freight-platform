...
import { Warehouse, Check, Package, BarChart3, Zap } from 'lucide-react';
import { motion } from 'framer-motion';

export default function Warehousing() {
  const benefits = [
    { icon: Package, title: 'Inventory Management', desc: 'Advanced tracking and stock level optimization' },
    { icon: BarChart3, title: 'Visibility', desc: 'Real-time reporting and analytics for decision-making' },
    { icon: Zap, title: 'Efficiency', desc: 'Fast order fulfillment and distribution capabilities' },
  ];
  ...
  const features = [
    ...
    'Flexible space and duration options',
  ];
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#D50000]/20 flex items-center justify-center">
                <Warehouse className="w-6 h-6 text-[#D50000]" />
              </div>
              <span className="text-[#D50000] font-bold text-lg">Warehousing Solutions</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter max-w-3xl">
              Smart <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D50000] to-[#FF6B6B]">Storage & Distribution</span>
            </h1>

            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl font-light">
              Modern warehousing solutions with inventory management, fulfillment services, and distribution capabilities.
            </p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Why Choose Our Warehousing?</h2>
            <p className="text-lg text-gray-600 max-w-2xl">Optimize your supply chain with secure storage and efficient distribution.</p>
          </motion.div>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A]">Our Warehousing Features</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#D50000] to-[#B00000]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Need Storage Solutions?</h2>
            <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">Let us manage your inventory with state-of-the-art facilities and systems.</p>
            <Link to={createPageUrl('RequestQuote')}>
