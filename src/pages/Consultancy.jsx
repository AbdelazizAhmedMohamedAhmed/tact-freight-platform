...
import { Briefcase, Check, Lightbulb, Users, TrendingUp } from 'lucide-react';
import { motion } from 'framer-motion';

export default function Consultancy() {
  const benefits = [
    { icon: Lightbulb, title: 'Strategic Insights', desc: 'Expert analysis and optimization of your supply chain' },
    { icon: Users, title: 'Expert Team', desc: 'Industry veterans with decades of logistics experience' },
    { icon: TrendingUp, title: 'Growth', desc: 'Solutions designed to improve efficiency and reduce costs' },
  ];
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#D50000]/20 flex items-center justify-center">
                <Briefcase className="w-6 h-6 text-[#D50000]" />
              </div>
              <span className="text-[#D50000] font-bold text-lg">Logistics Consultancy</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter max-w-3xl">
              Supply Chain <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D50000] to-[#FF6B6B]">Advisory</span>
            </h1>

            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl font-light">
              Transform your logistics operations with strategic consulting from industry experts. Optimize costs, improve efficiency, and drive growth.
            </p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Why Choose Our Consultancy?</h2>
            <p className="text-lg text-gray-600 max-w-2xl">Leverage decades of experience to optimize your supply chain and achieve business goals.</p>
          </motion.div>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A]">Our Consultancy Services</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#D50000] to-[#B00000]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">Let our consultants help you transform your supply chain.</p>
            <Link to={createPageUrl('Contact')}>
