...
import { Truck, Check, MapPin, Headphones, TrendingUp } from 'lucide-react';
import { motion } from 'framer-motion';

export default function InlandTransport() {
  const benefits = [
    { icon: MapPin, title: 'Widespread Coverage', desc: 'Door-to-door delivery across extensive land routes' },
    { icon: Headphones, title: 'Personal Service', desc: 'Dedicated support for each shipment throughout transit' },
    { icon: TrendingUp, title: 'Efficiency', desc: 'Optimized routes and timely deliveries at competitive rates' },
  ];
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#D50000]/20 flex items-center justify-center">
                <Truck className="w-6 h-6 text-[#D50000]" />
              </div>
              <span className="text-[#D50000] font-bold text-lg">Inland Transport Solutions</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter max-w-3xl">
              Door-to-Door <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D50000] to-[#FF6B6B]">Land Logistics</span>
            </h1>

            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl font-light">
              Reliable ground transportation solutions connecting your cargo from warehouse to destination with precision and care.
            </p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Why Choose Our Inland Transport?</h2>
            <p className="text-lg text-gray-600 max-w-2xl">Flexibility and reliability for last-mile delivery and regional logistics needs.</p>
          </motion.div>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A]">Our Inland Transport Features</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#D50000] to-[#B00000]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Transport?</h2>
            <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">Let us handle your inland logistics with professionalism and care.</p>
            <Link to={createPageUrl('RequestQuote')}>
