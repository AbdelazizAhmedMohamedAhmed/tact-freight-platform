...
import { FileCheck, Check, Shield, Clock, Briefcase } from 'lucide-react';
import { motion } from 'framer-motion';

export default function CustomsClearance() {
  const benefits = [
    { icon: Shield, title: 'Compliance', desc: 'Full adherence to all international customs regulations' },
    { icon: Clock, title: 'Speed', desc: 'Expert handling to minimize clearance delays' },
    { icon: Briefcase, title: 'Expertise', desc: 'Experienced team with extensive regulatory knowledge' },
  ];
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#D50000]/20 flex items-center justify-center">
                <FileCheck className="w-6 h-6 text-[#D50000]" />
              </div>
              <span className="text-[#D50000] font-bold text-lg">Customs Clearance Services</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter max-w-3xl">
              Expert <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D50000] to-[#FF6B6B]">Customs Brokerage</span>
            </h1>

            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl font-light">
              Navigate complex customs regulations with confidence. Our expert brokers ensure smooth clearance and compliance with all requirements.
            </p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Why Choose Our Customs Services?</h2>
            <p className="text-lg text-gray-600 max-w-2xl">Reduce clearance times and avoid costly penalties with professional customs expertise.</p>
          </motion.div>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A]">Our Customs Clearance Services</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#D50000] to-[#B00000]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Need Customs Support?</h2>
            <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">Our licensed brokers are ready to guide you through the clearance process.</p>
            <Link to={createPageUrl('RequestQuote')}>
