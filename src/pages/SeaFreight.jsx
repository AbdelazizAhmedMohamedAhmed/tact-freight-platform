...
import { Ship, Check, Globe, Lock, Zap } from 'lucide-react';
import { motion } from 'framer-motion';

export default function SeaFreight() {
  const benefits = [
    { icon: Globe, title: 'Global Coverage', desc: 'Access to major shipping lanes and ports worldwide' },
    { icon: Lock, title: 'Secure Handling', desc: 'Full container tracking and cargo protection' },
    { icon: Zap, title: 'Cost Effective', desc: 'Competitive rates for FCL and LCL shipments' },
  ];

  const features = [
    'Full Container Load (FCL) solutions',
    'Less Than Container Load (LCL) services',
    'Vessel selection and consolidation',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20 w-full">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[#D50000] font-bold text-lg">Sea Freight Solutions</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter max-w-3xl">
              Global <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D50000] to-[#FF6B6B]">Ocean Shipping</span>
            </h1>

            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl font-light">
              Cost-effective and reliable sea freight solutions for businesses of all sizes. From FCL to LCL, we handle your cargo with precision and care across global trade routes.
            </p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Why Choose Our Sea Freight Services?</h2>
            <p className="text-lg text-gray-600 max-w-2xl">Decades of expertise in ocean logistics with a global network of partners and cutting-edge technology.</p>
          </motion.div>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A]">Our Sea Freight Features</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#D50000] to-[#B00000]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">Let our team handle your ocean freight with expertise and care.</p>
            <Link to={createPageUrl('RequestQuote')}>
