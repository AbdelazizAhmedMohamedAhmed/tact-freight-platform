...
import { Car, Check, Shield, TrendingUp, Award } from 'lucide-react';
import { motion } from 'framer-motion';

export default function RoRoServices() {
  const benefits = [
    { icon: Shield, title: 'Vehicle Protection', desc: 'Secure handling and transport of vehicles and machinery' },
    { icon: TrendingUp, title: 'Cost Efficiency', desc: 'Optimized shipping solutions for bulk vehicle transport' },
    { icon: Award, title: 'Reliability', desc: 'Proven expertise in automotive and machinery logistics' },
  ];

  const features = [
    'Roll-on/Roll-off vessel services',
    'Vehicle loading and securing',
    'Machinery and heavy equipment transport',
    'Damage-free delivery guarantee',
    'Global automotive routes',
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#D50000]/20 flex items-center justify-center">
                <Car className="w-6 h-6 text-[#D50000]" />
              </div>
              <span className="text-[#D50000] font-bold text-lg">RoRo Services</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter max-w-3xl">
              Vehicle & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D50000] to-[#FF6B6B]">Machinery Shipping</span>
            </h1>

            <p className="mt-8 text-lg text-white/70 leading-relaxed max-w-2xl font-light">
              Specialized roll-on/roll-off services for vehicles, machinery, and heavy equipment. Safe, efficient, and reliable transport globally.
            </p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Why Choose Our RoRo Services?</h2>
            <p className="text-lg text-gray-600 max-w-2xl">Expert handling of vehicles and machinery with damage-free guarantees.</p>
          </motion.div>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A]">Our RoRo Services</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#D50000] to-[#B00000]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Need Vehicle Shipping?</h2>
            <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">Trust us with your automotive and machinery transport needs.</p>
            <Link to={createPageUrl('RequestQuote')}>
