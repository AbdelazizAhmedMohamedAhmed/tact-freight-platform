      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs defaultValue="details" className="mt-4">
          ...
          <TabsContent value="details" className="space-y-6 mt-4">
            ...
            {!isReadOnly && canUploadQuotation && (role === 'pricing' || role === 'admin') && rfq.status === 'pricing_in_progress' && (
              <div className="space-y-4 pt-4 border-t">
            ...
            {!isReadOnly && isStaff && (role === 'admin' || role === 'sales') && ['client_confirmed', 'sent_to_client', 'quotation_ready'].includes(rfq.status) && (!rfq.final_status || rfq.final_status === 'pending') && (
              <div className="space-y-4 pt-4 border-t">
